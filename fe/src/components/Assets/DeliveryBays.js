    ...
    if(tabIndex === "1") {
      return (
        <Box sx={{ display: 'flex', flexDirection: 'column', flex: '1', height: '100%', minWidth: '500px'}}>
          ...
          >
            <p style={{fontSize: '1.5rem', fontWeight: '300', color: '#505e71'}}>Delivery Bay Info</p>
          </Box>
          <Box sx={{display: 'flex', flexDirection: 'column', height: 'calc(100% - 75px)'}}>
            ...
            <Box sx={{ display: 'flex', width: '100%', justifyContent: 'space-between', borderBottom: 2, borderColor: '#edf2f6', padding: '30px' }}>
              <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', justifyContent: 'center'}}>
                <p style={{fontSize: '0.875rem', color: '#889ab1', fontWeight: '300', marginBottom: '5px'}}>Maximum Length</p>
    ...
    <>
            ...
            >
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <img style={{width: '32px', height: '32px', filter: "invert(36%) sepia(18%) saturate(535%) hue-rotate(175deg) brightness(94%) contrast(93%)"}} src={require("../../icons/truck.png")} alt="Crane"/>
                </Box>
                <Box sx={{
                  display: 'flex',
                ...
                >
                      ...
                      <React.Fragment>
                        <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%'}}>
                          <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: '0px 20px'}}>
                            <img style={{width: '32px', height: '32px'}} src={require("../../icons/truck.png")} alt="Crane"/>
                            <Box sx={{height: '50px', borderLeft: 1, borderColor: '#edf2f6', margin: '0px 25px'}}/>
                            <Typography sx={{fontWeight: 400, fontSize: '1.125rem'}}>Bay Info</Typography>
                          </Box>
                          <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: '0px 20px'}}>
                            <ChevronRight/>
                          </Box>
                  ...
                  <AntTab value="5" label={
                      <React.Fragment>
                        <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%'}}>
                          <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: '0px 20px'}}>
                            <img style={{width: '32px', height: '32px'}} src={require("../../icons/mcrane.png")} alt="Loading Platforms"/>
                            <Box sx={{height: '50px', borderLeft: 1, borderColor: '#edf2f6', margin: '0px 25px'}}/>
      ...
      >
        <Box sx={style}>
          ...
          <Box sx={{display: 'flex', margin: '50px 20px', alignItems: 'center', flexDirection: 'column'}}>
              <h3 style={{textAlign: 'center', color: '#505e71', fontWeight: '600', fontSize: '2.125rem', marginBottom: '55px'}}>Set Delivery Bay Name</h3>
              <Box>
                <p style={{color: '#889ab1', fontWeight: '300', fontSize: '0.875rem', marginBottom: '5px'}}>Name</p>
