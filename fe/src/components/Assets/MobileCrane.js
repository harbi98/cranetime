    ...
    <>
      ...
      >
        <Box display="flex" sx={{
          ...
          <TextField
            ...
            placeholder='Search Mobile Cranes...'
            InputProps={{
              endAdornment: (
                <SearchIcon/>
              ),
        ...
        <Box display="flex" sx={{
          ...
          <Box display="flex" sx={{height: '100%'}}>
            ...
            <Box display="flex" justifyContent="center" alignItems="center" sx={{position: 'fixed', bottom: 0, height: '100px', width: 415, padding: '15px 20px', borderTop: 2, borderTopColor: '#edf2f6'}}>
              <AddButton sx={{width: '100%', height: '100%'}} onClick={() => handleOpen()}>Add Mobile Crane</AddButton>
            </Box>
          </Box>
        </Box>
      </Box>
      ...
      >
        <Box sx={style}>
          ...
          <Box sx={{display: 'flex', margin: '50px 20px', alignItems: 'center', flexDirection: 'column'}}>
            <h3 style={{textAlign: 'center', color: '#505e71', fontWeight: '600', fontSize: '2.125rem', marginBottom: '55px'}}>Add Mobile Crane</h3>
            <Box>
      ...
      >
        <Box sx={style}>
          ...
          <Box sx={{display: 'flex', margin: '50px 20px', alignItems: 'center', flexDirection: 'column'}}>
              <h3 style={{textAlign: 'center', color: '#505e71', fontWeight: '600', fontSize: '2.125rem', marginBottom: '55px'}}>Set Mobile Crane Name</h3>
              <Box>
                <p style={{color: '#889ab1', fontWeight: '300', fontSize: '0.875rem', marginBottom: '5px'}}>Name</p>
