    ...
    if(tabIndex === "1") {
      return (
        <Box sx={{ display: 'flex', flexDirection: 'column', flex: '1', height: '100%', minWidth: '500px'}}>
          ...
          >
            <p style={{fontSize: '1.5rem', fontWeight: '300', color: '#505e71'}}>Telehandler Info</p>
          </Box>
      ...
      >
        <Box display="flex" sx={{
          ...
          <TextField
            ...
            placeholder='Search Material Handling...'
            InputProps={{
              endAdornment: (
                <SearchIcon/>
              ),
        ...
        <Box display="flex" sx={{
          ...
          <Box display="flex" sx={{height: '100%'}}>
            ...
            <Box display="flex" justifyContent="center" alignItems="center" sx={{position: 'fixed', bottom: 0, height: '100px', width: 415, padding: '15px 20px', borderTop: 2, borderTopColor: '#edf2f6'}}>
              <AddButton sx={{width: '100%', height: '100%'}} onClick={() => handleOpen()}>Add Material Handling</AddButton>
            </Box>
          </Box>
        </Box>
      </Box>
        ...
        >
          <Box sx={{
            ...
            <Box sx={{
              ...
              <img style={{width: '32px', height: '32px', filter: "invert(36%) sepia(18%) saturate(535%) hue-rotate(175deg) brightness(94%) contrast(93%)"}} src={require("../../icons/lifter.png")} alt="Crane"/>
            </Box>
            <Box sx={{
              display: 'flex',
                  ...
                  <React.Fragment>
                    <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%'}}>
                      <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: '0px 20px'}}>
                        ...
                        <Typography sx={{fontWeight: 400, fontSize: '1.125rem'}}>Telehandler Info</Typography>
                      </Box>
                      <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: '0px 20px'}}>
                        <ChevronRight/>
                      </Box>
